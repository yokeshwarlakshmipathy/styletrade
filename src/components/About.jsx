  ...
  return (
    <section id="about" className="bg-black text-white pt-24 px-4 pb-16">
      <div className="max-w-5xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-green-400">About StyleTrade</h2>
        <p className="text-gray-400 text-base md:text-lg mb-4">
          Learn to trade the smart way — from price action to psychology — all in one practical ecosystem.
        </p>
        <p className="text-gray-300 text-base md:text-lg leading-relaxed">
          StyleTrade is your gateway to mastering the financial markets. We offer structured and easy-to-digest education
        ...
        <div className="mt-10 grid md:grid-cols-3 gap-6 text-left">
          ...
          <div className="bg-white/5 p-6 rounded-xl border border-white/10">
            ...
            <p className="text-gray-400">
              Practical sessions. Trade journaling. Mindset mastery. StyleTrade is not a shortcut — it’s a system that works.
            </p>
          </div>
        </div>
      </div>
